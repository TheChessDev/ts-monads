 ...
 */
export function Left<L extends NonUndefined, R extends NonUndefined = never>(val: L): LeftEither<L, R> {
 ...
 */
export function Right<R extends NonUndefined, L extends NonUndefined = never>(val: R): RightEither<L, R> {
 ...
 */
export function isLeft<L extends NonUndefined, R extends NonUndefined>(val: Either<L, R>): val is LeftEither<L, R> {
    return val.isLeft();
}
 ...
 */
export function isRight<L extends NonUndefined, R extends NonUndefined>(val: Either<L, R>): val is RightEither<L, R> {
    return val.isRight();
}
